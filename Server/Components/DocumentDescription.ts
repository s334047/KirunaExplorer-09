...
class DocumentDescription {
    ...
    constructor(id: number, title: string, stakeholder: string, scale: string, date: string, type: string, language: string, page: number, coordinate: number[], area: object, description: string) {
        this.id = id;
        this.title = title;
